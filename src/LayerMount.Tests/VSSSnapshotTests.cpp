...
// apartment. The test host's thread already holds an apartment that rejects
// COINIT_MULTITHREADED, so every body that uses this runs inside
// RunOnComFreeThread (see TestFixture.h).
class ComInit {
public:
    ComInit() {
